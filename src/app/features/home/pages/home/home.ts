...
export class Home {
  ...
  readonly featureCards: FeatureCard[] = [
    {
      ...
      eyebrow: 'قراءة واضحة',
      description:
        'انتقل بين السور واقرأ بالرسم العثماني مع وضع المصحف ووضع التركيز لتجربة قراءة أهدأ.',
      icon: 'quran',
      id: 'quran',
      action: 'ابدأ القراءة',
      route: '/quran',
  ...
  readonly routineSteps: RoutineStep[] = [
    {
      ...
      description:
        'تابع التسبيح، التحميد، الاستغفار، الصلاة على النبي، وقراءة القرآن بتقدم بسيط لليوم.',
      marker: '01',
    },
    {
      title: 'خذ وقفة هادئة',
      description: 'ارجع لآية وحديث وذكر مختارين لليوم يساعدوك تبدأ بخطوة بسيطة.',
      marker: '02',
    },
    {
      title: 'احفظ ما يلمسك',
  ...
  readonly values: ValueItem[] = [
    ...
    {
      title: 'استمرارية',
      description: 'متابعة ورد يومي ومفضلة ونسخ سريع يساعدوك تحافظ على القرب خطوة بخطوة.',
      marker: '03',
    },
  ];
